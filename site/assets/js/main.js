(function () {
  ...
  function initWhatsAppForm() {
    ...
    form.addEventListener('submit', function (e) {
      ...
      var fields = ['nome', 'telefone', 'modalidade', 'objetivo', 'horario'];
      var valid = true;
      ...
      var msg = '*Olá! Quero agendar aula experimental no Dojo Impacto*\n\n';
      msg += '🥋 *Dados do agendamento*\n';
      msg += '• Nome: ' + nome + '\n';
      msg += '• Telefone: ' + telefone + '\n';
      msg += '• Modalidade: ' + modalidade + '\n';
      msg += '• Objetivo: ' + objetivo + '\n';
      msg += '• Melhor horário: ' + horario + '\n';
  ...
  function showToast() {
    ...
    toast.style.cssText =
      'position:fixed;top:100px;right:2rem;background:linear-gradient(135deg,#dc2626,#b91c1c);' +
